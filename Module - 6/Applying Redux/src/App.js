    ...
    <>
      <div className='TaskManager rounded'>
        <div className='pops bg-light mx-auto mt-5 p-2'>
          <div>
            <h2 className='ms-3 mt-3'>Search Products: shirt</h2>
          </div>
          <div className='d-flex justify-content-between m-0 p-3'>
            <div className=''>
              <div class="input-group mb-3">
                <input type="text" class="form-control" placeholder="shirt" aria-label="Username" aria-describedby="basic-addon1"/>
                <span class="input-group-text" id="basic-addon1"><i className='bi bi-search'></i></span>
              </div>
            </div>
            <div className=''>
              <button className='btn btn-primary' onClick={handleShow}><i class="bi bi-plus"></i> Create Product</button>
            </div>
          </div>
